...
public class ContaController {
	...
	public ResponseEntity<String> TransferenciaPix(@RequestBody HashMap<String, String> conta) {
		try {
			...
			ValidacaoTransferencia.validarTransferencia(idContaOrigem, cpfDestino, valor);
			...
			Transferencia transf = new Transferencia(conta1.getNumeroConta(), conta2.getNumeroConta(), valor,
					TipoPagamento.PIX);
